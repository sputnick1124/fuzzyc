...
int main(int argc, char * argv[]) {
	...
	double input_list1[2][3] = {*size_small, *weight_small};
	double input_list2[2][3] = {*size_small, *weight_large};
	double input_list3[2][3] = {*size_large, *weight_small};
	double input_list4[2][3] = {*size_large, *weight_large};

	double output_list1[1][3] = {*qual_bad};
	double output_list2[1][3] = {*qual_med};
	double output_list3[1][3] = {*qual_good};
